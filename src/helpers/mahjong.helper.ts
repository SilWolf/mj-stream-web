...
export const formatPlayerResultsByPrev = (
  ...
  return {
    ...
    '1': {
      ...
      isRevealed: false,
      isRiichi: false,
      isYellowCarded: prev['1'].isYellowCarded,
      isRedCarded: prev['1'].isRedCarded,
      type: PlayerResultWinnerOrLoserEnum.None,
      scoreChanges: [],
    ...
    '2': {
      ...
      isRevealed: false,
      isRiichi: false,
      isYellowCarded: prev['2'].isYellowCarded,
      isRedCarded: prev['2'].isRedCarded,
      type: PlayerResultWinnerOrLoserEnum.None,
      scoreChanges: [],
    ...
    '3': {
      ...
      isRevealed: false,
      isRiichi: false,
      isYellowCarded: prev['3'].isYellowCarded,
      isRedCarded: prev['3'].isRedCarded,
      type: PlayerResultWinnerOrLoserEnum.None,
      scoreChanges: [],
