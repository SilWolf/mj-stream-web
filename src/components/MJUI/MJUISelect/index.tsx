...
export default function MJUISelect({
  ...
  const myClassName = useMemo(
    () =>
      `block w-full rounded-md border-0 px-1 py-[9px] text-gray-900 shadow-xs ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 ${className}`,
    [className]
  )
