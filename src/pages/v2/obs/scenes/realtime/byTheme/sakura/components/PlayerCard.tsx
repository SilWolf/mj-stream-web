...
export default function PlayerCard({
  ...
  return (
    ...
    >
      ...
      <div
        className={`border-4 p-2 pt-12 rounded-[.2em] ${isEast ? 'border-error' : 'border-transparent'}`}
      >
        <div className="relative flex flex-col gap-y-[0.125em] items-end justify-end">
          ...
          <div className="flex gap-[0.125em] relative">
            ...
            <div
              className="bg-black/50 rounded-[.25em] text-[0.5em] flex gap-x-[0.2em] p-[0.2em] pl-[0.2em] pr-[0.2em] opacity-0 transition-opacity data-[has-waiting-tiles='1']:opacity-100 hide-if-changing"
          ...
          <div
            className="self-end text-[0.4em] mr-[0.1em] leading-none text-white hide-if-changing font-semibold whitespace-nowrap"
            style={{
              textShadow:
