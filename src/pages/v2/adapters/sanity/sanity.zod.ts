...
export const matchSchema = z.object({
  ...
  resultUploadedAt: z.string().optional(),
  status: z.union([z.literal('initialized'), z.literal('completed')]).optional(),
    ...
    .array(
      z.object({
        ...
        playerEast: z
          .object({
            position: z
              .union([z.literal('east'), z.literal('south'), z.literal('west'), z.literal('north')])
              .optional(),
            status: z
              .union([z.literal('none'), z.literal('isRiichied'), z.literal('isRevealed')])
              .optional(),
            isWaited: z.boolean().optional(),
            type: z.union([z.literal('none'), z.literal('win'), z.literal('lose')]).optional(),
...
export const matchTournamentSchema = z.object({
  ...
  yakumanMax: z
    .union([z.literal('13'), z.literal('26'), z.literal('39'), z.literal('130')])
    .optional(),
  teams: z
    .array(
      z.object({
